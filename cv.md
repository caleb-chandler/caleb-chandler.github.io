...
<div class="notice--info">
  <p>You can download a PDF version of my CV using the button below:</p>
  <a href="{{ '/assets/docs/calebchandler-cv-csh.pdf' | relative_url }}" class="btn btn--primary" download>Download CV (PDF)</a>
</div>

## Online Viewer

<div style="position: relative; width: 100%; height: 0; padding-bottom: 129%; margin-bottom: 2em;">
  <iframe 
    src="{{ '/assets/docs/calebchandler-cv-csh.pdf' | relative_url }}" 
    style="position: absolute; width: 100%; height: 100%; left: 0; top: 0;" 
    frameborder="0">
    This browser does not support inline PDFs. Please download the PDF to view it: 
    <a href="{{ '/assets/docs/calebchandler-cv-csh.pdf' | relative_url }}">Download PDF</a>
  </iframe>
</div>
