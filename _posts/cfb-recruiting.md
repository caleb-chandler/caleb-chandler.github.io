...
![image of a network](C:\Users\User\website\caleb-chandler.github.io\assets\Network-visualization-illustration.jpg)
...
![visualization of portal for 2025](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\2025.png)
...
![image of a small-world network](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\smallworld.jpg)
...
![degree distribution of average transfer portal network](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\transfer_degree_distribution.png)
...
![visualization of network, with higher divisions in middle and lower ones forming concentric circles around them](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\fr_bydiv_indegsize_white.png)
...
![described below](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\avg_pagerank_hits_network.png)
...
|     11 | East Carolina     |    0.00816 | South Alabama           |      0.01164 |
|     12 | Arkansas State    |    0.00809 | Oklahoma                |      0.0115  |
|     13 | Marshall          |    0.008   | Arkansas State          |      0.01137 |
|     14 | App State         |    0.00757 | Georgia Tech            |      0.01107 |
|     15 | Michigan State    |    0.00748 | Houston                 |      0.01073 |
...
![distribution](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\distribution_net_degree.png)

When we isolate the top and bottom schools by aggregate (summed) NPG, we get something interesting.

![table showing top and bottom schools](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\agg_nd.png)
...
![scatter plot showing correlation](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\scatter_net_degree_vs_npv.png)

If we control for NPG and isolate the effect of NPV, however, we get this:

![scatter plot of efficiency residuals vs NPG](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\aggregated_portal_efficiency_by_division.png)
...
<iframe 
  src="C:\Users\User\website\caleb-chandler.github.io\assets\cfb\transfer_sankey_div.html" 
  width="100%" 
  height="800px" 
  frameborder="0" 
  scrolling="no">
...
These are Sankey diagrams, made for visualizing flow rates. Used here, they show all the journeys made by transferring players over the past five seasons by division. We can see that in general, lower divisions have more total inflow than outflow, while P4 shows the opposite. 
    Here's a [link](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\sankey_conf.html) to a version that further subdivides by conference, if you'd like to check that out as well.
...
![table of top schools by in-degree and out-degree](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\indeg_outdeg.png)
...
![bar plot of in vs out by division](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\avg_degree_by_division_seaborn.png)
...
![img](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\parity_analysis.png)
...
![img](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\recruiting_degree_distribution.png)
...
![img](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\average_communities_totalvolume_allnames.png)

See anything? Let's try adding labels to the communities:

![img](C:\Users\User\website\caleb-chandler.github.io\assets\cfb\labeled.png)
...
So that's it; hope you enjoyed, learned something, etc, etc. You can check out the project repo on my GitHub at https://github.com/caleb-chandler/cfb-player-acquisition-network.git. Terms and conditions prohibit me from publishing the data directly, but the code's all there to re-gather the data with your own API key. If you decide to expand on the project, let me know! There's a ton more that could be done here and I'd love to see what else people think of.